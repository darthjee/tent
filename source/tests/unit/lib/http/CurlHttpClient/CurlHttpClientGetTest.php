...
class CurlHttpClientGetTest extends TestCase
{
    ...
    public function testRequestReturnsArrayWithCorrectKeys()
    {
        ...
        $result = $client->request('GET', $this->baseUrl . '/get', []);
    ...
    public function testRequestWithHeaders()
    {
        ...
        $result = $client->request('GET', $this->baseUrl . '/headers', $headers);
    ...
    public function testRequestHandles404()
    {
        ...
        $result = $client->request('GET', $this->baseUrl . '/status/404', []);
    ...
    public function testRequestWithQueryParameters()
    {
        ...
        $result = $client->request('GET', $this->baseUrl . '/get?test=value&foo=bar', []);
