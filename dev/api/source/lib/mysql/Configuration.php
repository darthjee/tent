...
class Configuration
{
     ...
     */
    public static function configure(string $host, string $database, string $username, string $password, int $port = 3306): Configuration
    {
     ...
     * @return Connection The database connection
     */
    public static function connectWithoutDatabase(string $host, string $username, string $password, int $port = 3306): Connection
    {
     ...
     * @return void
     */
    public static function createDatabase(string $host, string $username, string $password, int $port, string $databaseName): void
    {
     ...
     */
    public static function databaseExists(string $host, string $username, string $password, int $port, string $databaseName): bool
    {
        $conn = self::connectWithoutDatabase($host, $username, $password, $port);
     ...
     * @return void
     */
    public static function ensureDatabaseExists(string $host, string $username, string $password, int $port, string $databaseName): void
    {
